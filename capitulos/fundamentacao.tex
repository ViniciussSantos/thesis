...
\begin{itemize}
    ...
    \item \textbf{Amplificação de Espaço (Space Ampliﬁcation - SA):} Decorre da presença temporária de dados duplicados ou obsoletos antes que sejam removidos por compactação.
\end{itemize}
