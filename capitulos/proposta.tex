...
Dessa forma, o problema reside em como transformar o processo de compactação de um \enquote{mal necessário} executado às cegas em um processo consciente do hardware e da carga de trabalho, que maximize a vazão (throughput) sem comprometer a integridade da estrutura da árvore LSM.
